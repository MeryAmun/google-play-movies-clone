...
const TopNewReleases = () => {
  ...
  <div className=" d-flex flex-column justify-content-start">
    <h2 className="text-dark font-weight-bold">Top new movie releases to rent or buy</h2>
    <p className="text-secondary font-weight-normal">From the big screen to your screen</p>
  </div>
